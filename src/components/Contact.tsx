    ...
    <section id="contacto" className="py-24 bg-surface/50">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="https://www.linkedin.com/in/gorka-reguero-aa47491aa/"
            target="_blank"
          ...
          <a
            href="mailto:gorkareguero@gmail.com"
            className="inline-flex items-center gap-2 border border-border hover:border-accent text-foreground px-6 py-3 rounded-lg font-medium transition-colors"
          >
        ...
        <footer className="mt-20 pt-8 border-t border-border text-sm text-muted">
          <p>© {new Date().getFullYear()} Gorka Reguero. Hecho con Next.js & TypeScript.</p>
        </footer>
      </div>
    </section>
  );
